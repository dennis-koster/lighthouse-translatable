{{--
    ...
    root type through this stub. For instance, you might want to add a `@hasMany` directive to
    the generated output to optimize query performance. You could do that by changing this blade
    file to:
